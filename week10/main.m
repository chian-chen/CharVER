...
for i = 1 : k
    ...
    % Erosion
    Features(i, 11:13) = Erosion_Feature(B);
    
    % Moment
    Features(i, 14:22) = Moment_Feature(B);
    
    % width
    Features(i, 25:26) = Width_Feature(B);
    
    % Endpoint
    Features(i, 27:56) = EndPoint_Feature(B);
    
    % Turnpoint
    Features(i, 57:68) = TurnPoint_Feature(B);
...
% =============================================
% ========= Preprocessing (sift) ==============
% (1) set 90% zeros columns to all zeros
